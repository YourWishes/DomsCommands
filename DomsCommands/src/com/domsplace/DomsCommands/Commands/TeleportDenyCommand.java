 ...
 * @since       08/10/2013
 */
public class TeleportDenyCommand extends BukkitCommand {
    ...
    public boolean cmd(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        sendMessage(sender, ChatDefault + "Denied the request.");
        sendMessage(tpr.getFrom(), ChatImportant + tpr.getTo() + ChatDefault + " denied your request.");
