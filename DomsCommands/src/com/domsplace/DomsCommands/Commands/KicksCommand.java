 ...
 */
public class KicksCommand extends BukkitCommand {    
    public KicksCommand() {
        super("kicks");
    ...
    public boolean cmd(CommandSender sender, Command cmd, String label, String[] args) {
        if(args.length < 1) {
            sendMessage(sender, ChatError + "Please enter a player name or kick ID.");
            return false;
        }
        ...
        List<Punishment> bans = player.getPunishmentsOfType(PunishmentType.KICK);
