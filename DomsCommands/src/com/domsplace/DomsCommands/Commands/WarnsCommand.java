 ...
 */
public class WarnsCommand extends BukkitCommand {    
    public WarnsCommand() {
        super("warns");
    ...
    public boolean cmd(CommandSender sender, Command cmd, String label, String[] args) {
        if(args.length < 1) {
            sendMessage(sender, ChatError + "Please enter a player name or warn ID.");
            return false;
        }
        ...
        List<Punishment> bans = player.getPunishmentsOfType(PunishmentType.WARN);
